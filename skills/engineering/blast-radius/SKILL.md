...
1. Read the change. The diff, the symbols it adds, changes, and deletes, and what it now does differently, including the part the diff doesn't spell out. Read `../why/SKILL.md` and use step 2 to pull the PR and commits.
...
6. For a big or wide change, read `../arena/SKILL.md` and run it as an `arena`. Ask several models the same question and merge the answers. Different models catch different real bugs.
