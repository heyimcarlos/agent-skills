...
Start by finding the relevant code. Use file search to find directories and files, `rg` to find key symbols, and targeted reads to understand the actual implementation. Don't guess from names. Read the code.
